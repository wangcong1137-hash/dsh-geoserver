window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/wangcong/.dsh/profiles/web/plugins/dsh-geoserver/src/client/fields.module.css.mjs
		const css$1 = "._7q3NBW_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}._7q3NBW_field+._7q3NBW_field{border-top:1px solid var(--dsw-alias-border-l2)}._7q3NBW_head{align-items:center;gap:8px;display:flex}._7q3NBW_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}._7q3NBW_badges{align-items:center;gap:8px;display:inline-flex}._7q3NBW_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}._7q3NBW_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}._7q3NBW_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}._7q3NBW_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}._7q3NBW_reset:disabled{cursor:default}._7q3NBW_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}._7q3NBW_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}._7q3NBW_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}._7q3NBW_inputInvalid{border-color:var(--dsw-alias-label-error);}._7q3NBW_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}._7q3NBW_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"badges": "_7q3NBW_badges",
			"hint": "_7q3NBW_hint",
			"reset": "_7q3NBW_reset",
			"badgeMuted": "_7q3NBW_badgeMuted",
			"badge": "_7q3NBW_badge",
			"inputInvalid": "_7q3NBW_inputInvalid",
			"input": "_7q3NBW_input",
			"label": "_7q3NBW_label",
			"head": "_7q3NBW_head",
			"invalid": "_7q3NBW_invalid",
			"field": "_7q3NBW_field"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/wangcong/.dsh/profiles/web/plugins/dsh-geoserver/src/client/PluginCard.module.css.mjs
		const css = ".DOHCQa_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.DOHCQa_card:hover{border-color:var(--dsw-alias-label-dimmed)}.DOHCQa_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.DOHCQa_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.DOHCQa_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.DOHCQa_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.DOHCQa_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.DOHCQa_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.DOHCQa_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.DOHCQa_chevronOpen{transform:rotate(180deg)}.DOHCQa_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.DOHCQa_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.DOHCQa_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.DOHCQa_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.DOHCQa_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.DOHCQa_discard,.DOHCQa_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.DOHCQa_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.DOHCQa_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.DOHCQa_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.DOHCQa_discard:disabled,.DOHCQa_save:disabled{opacity:.4;cursor:default}.DOHCQa_discard:focus-visible,.DOHCQa_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"readOnly": "DOHCQa_readOnly",
			"pending": "DOHCQa_pending",
			"headText": "DOHCQa_headText",
			"header": "DOHCQa_header",
			"body": "DOHCQa_body",
			"footer": "DOHCQa_footer",
			"description": "DOHCQa_description",
			"cardOpen": "DOHCQa_cardOpen",
			"failed": "DOHCQa_failed",
			"save": "DOHCQa_save",
			"name": "DOHCQa_name",
			"discard": "DOHCQa_discard",
			"card": "DOHCQa_card",
			"chevron": "DOHCQa_chevron",
			"chevronOpen": "DOHCQa_chevronOpen"
		};
		//#endregion
		...
		*/
		...
		var GeoserverCardController = class {
			...
			*/
			constructor(api) {
				this.api = api;
				this.form = new CardForm(new RouteSettingsScope(), [textField("baseUrl"), textField("username")], [{
